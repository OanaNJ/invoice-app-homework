...
import { InvoicesTable } from '../src/InvoicesTable';
import { ClientsTable } from '../src/ClientsTable';
...
export default function Dashboard() {
  return (
   ...
   >
     <Grid item  xs = {4} md = {6} >
       <ClientsTable data = {clientTableData} />
     </Grid>
     <Grid item  xs = {4} md = {6} >
       <InvoicesTable data = {invoiceTableData} />
     </Grid>
   </Grid>
  )
}